...
function useAdd(collectionPath) {
    var _this = this;
    ...
    var addFn = react_1.useCallback(function (data) {
        if (firestore) {
            var ref_1 = firestore.collection(collectionPath);
            var f = function (data) { return __awaiter(_this, void 0, void 0, function () {
                var err_1;
    ...
    return [addFn, { data: data, loading: loading, error: error }];
}
exports.default = useAdd;
