...
function useUpdate(collectionPath) {
    ...
    var setFn = react_1.useCallback(function (docId, data) {
        if (firestore) {
            var ref_1 = firestore.collection(collectionPath);
            var f = function (docId, data) { return __awaiter(_this, void 0, void 0, function () {
                var err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, ref_1.doc(docId).set(data)];
                        case 2:
                            _a.sent();
                            setLoading(false);
                            return [3 /*break*/, 4];
    ...
    return [setFn, { data: data, loading: loading, error: error }];
}
