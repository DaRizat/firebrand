...
function useUpdate(collectionPath) {
    ...
    var ref = firestore ? firestore.collection(collectionPath) : null;
    var updateFn = react_1.useCallback(function (docId, data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ref.doc(collectionPath + "/" + docId).update(data)];
                    case 2:
                        _a.sent();
                        setData('OK');
                        setLoading(false);
    ...
    return [updateFn, { data: data, loading: loading, error: error }];
}
